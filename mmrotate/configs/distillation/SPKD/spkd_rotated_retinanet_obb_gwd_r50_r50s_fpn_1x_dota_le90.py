...
# teacher cfg
distiller_cfg = dict(
    teacher_cfg="configs/distillation/rotated_retinanet_obb_gwd_r50_fpn_1x_dota_le90.py",
    teacher_pretrained="teacher_checkpoints/rotated_retinanet_obb_gwd_r50.pth",
)
prunning_ratio = 0.8
