...
# teacher cfg
distiller_cfg = dict(
    teacher_cfg="configs/distillation/hv_pointpillars_fpn_sbn-all_4x8_2x_nus-3d.py",
    teacher_pretrained="teacher_checkpoints/hv_pointpillars_fpn_2x_nus-3d.pth",
)
